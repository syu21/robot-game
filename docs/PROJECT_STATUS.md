...
- battle-cinematic-v1 のレーザーは `attack_element -> 攻撃側element/parts -> neutral` の順で `fire / water / thunder / wind / dark / light / neutral` を出し分ける。演出専用で戦闘計算・8ターン制・turn_logs・audit.*互換には影響しない
