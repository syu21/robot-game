...
- CT:
  - 一般: 40秒
  - 新規ブースト(登録後72h): 20秒
  - 研究ブースト(10分): 通常20秒 / 新規10秒
  - 課金ブースト(14日): 20秒、研究ブーストとは重複不可
  - 管理者: 0秒
- 研究ブーストの配布は `デイリーログイン / 実験室参加 / Xシェア` の日次3導線に整理し、Xシェアでは現在機体のOGP共有ページを投稿本文に含める
...
- 出撃CT は `admin 0秒 / 課金ブースト20秒 / 研究ブースト通常20秒・新規10秒 / 新規ブースト20秒 / 通常40秒`
