...
- [ ] `/parts` で `画像 / 部位 / レアリティ / +値 / 6ステ / 装備中表示 / 総合性能` が確認できる
- [ ] 6ステ、総合性能、戦闘中のHP/ダメージはプレイヤー向け表示だけ100倍になり、`+値 / コイン / ターン / 確率 / CT` は100倍されていない
- [ ] `/parts` の部位フィルター `すべて / 頭 / 右腕 / 左腕 / 脚` が動く
- [ ] `/parts` のソート `おすすめ順 / 新しい順 / 古い順 / 総合性能順 / +値順 / レアリティ順 / 部位順` が分かりやすく切り替わる
