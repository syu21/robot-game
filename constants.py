...
MODULE_PROTOCOL_DEFINITIONS = {
    "fortress_guard": {
        ...
        "name_ja": "要塞防御",
        "short_description": "1〜3ターン目の被ダメージを15%軽減",
    ...
    "emergency_repair": {
        ...
        "name_ja": "緊急修復",
        "short_description": "HP30%以下で一度だけ最大HPの12%回復",
    ...
    "opening_acceleration": {
        ...
        "required_brand_count": 2,
        "name_ja": "開幕加速",
        "short_description": "1〜2ターン目のみ素早さを20%上昇",
        "trigger_type": "battle_start",
        "max_activations": 2,
        "is_active": True,
    },
    "critical_chain": {
        ...
        "required_brand_count": 3,
        "name_ja": "会心連鎖",
        "short_description": "会心後、次の自分の攻撃だけ会心率+15",
    ...
    "target_analysis": {
        ...
        "required_brand_count": 2,
        "name_ja": "標的解析",
        "short_description": "戦闘中、命中判定に+10",
        "trigger_type": "battle_start",
        "max_activations": 1,
        "is_active": True,
    },
    "miss_correction": {
        ...
        "required_brand_count": 3,
        "name_ja": "誤差修正",
        "short_description": "MISS後、次の自分の攻撃だけ必中",
    ...
    "limit_break": {
        ...
        "required_brand_count": 2,
        "name_ja": "限界突破",
        "short_description": "HP35%以下の間、攻撃+20%・防御-10%",
    ...
    "unstable_overdrive": {
        ...
        "required_brand_count": 3,
        "name_ja": "不安定過駆動",
        "short_description": "攻撃時20%で与ダメージ1.5倍、反動5%",
    ...
    "adaptive_shift": {
        ...
        "required_brand_count": 2,
        "name_ja": "適応変換",
        "short_description": "敵傾向に応じて1つの補正を戦闘中維持",
        "trigger_type": "battle_start",
        "max_activations": 1,
        "is_active": True,
    },
    "emergency_reconfiguration": {
        ...
        "required_brand_count": 3,
        "name_ja": "緊急再構成",
        "short_description": "4ターン目開始時、戦況に応じて1効果を適用",
