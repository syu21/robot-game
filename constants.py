...
AUDIT_EVENT_TYPES = {
    ...
    "ROBOT_PRESET_SAVE": "audit.robot.preset.save",
    "ROBOT_PRESET_APPLY": "audit.robot.preset.apply",
    "ROBOT_PRESET_RENAME": "audit.robot.preset.rename",
    "ROBOT_PRESET_DELETE": "audit.robot.preset.delete",
    ...
    "ONBOARDING_BOSS_RETRY_GUIDE_VIEW": "audit.onboarding.boss_retry.guide_view",
    "ONBOARDING_BOSS_RETRY_GUIDE_CLICK": "audit.onboarding.boss_retry.guide_click",
    "ONBOARDING_BOSS_RETRY_ADJUST_COMPLETE": "audit.onboarding.boss_retry.adjust_complete",
    "ONBOARDING_BOSS_RETRY_START": "audit.onboarding.boss_retry.start",
    "ONBOARDING_BOSS_RETRY_SUCCESS": "audit.onboarding.boss_retry.success",
    ...
    "LAYER1_BOSS_SIGNAL": "audit.layer1.boss_signal",
    "LAYER1_BOSS_ALERT": "audit.layer1.boss_alert",
    "LAYER1_BOSS_GUARANTEE_READY": "audit.layer1.boss_guarantee_ready",
    "LAYER1_BOSS_GUARANTEE_TRIGGER": "audit.layer1.boss_guarantee_trigger",
...
BATTLE_CODE_CONDITIONS = {
    ...
    "enemy_heavy": {
        "condition_key": "enemy_heavy",
        "name_ja": "重装反応《ヘヴィ・シグナル》",
        "short_description": "敵が重装特性を持つとき、命令を起動する。",
        "trigger_type": "enemy_trait",
        "trigger_value": "heavy",
        "max_condition_events": 1,
        "prefix_ja": "重装反応式",
        "prefix_en": "IRON",
    ...
    "enemy_fast": {
        ...
        "name_ja": "高速反応《スピード・シグナル》",
        "short_description": "敵が高速特性を持つとき、命令を起動する。",
        "trigger_type": "enemy_trait",
        "trigger_value": "fast",
        "max_condition_events": 1,
        "prefix_ja": "高速反応式",
    ...
    "enemy_berserk": {
        "condition_key": "enemy_berserk",
        "name_ja": "暴走反応《バーサーク・シグナル》",
        "short_description": "敵が暴走特性を持つとき、命令を起動する。",
        "trigger_type": "enemy_trait",
        "trigger_value": "berserk",
        "max_condition_events": 1,
        "prefix_ja": "暴走反応式",
        "prefix_en": "RED",
        "timing_label": "敵特性確認時",
    ...
    "enemy_unstable": {
        "condition_key": "enemy_unstable",
        "name_ja": "不安定反応《ノイズ・シグナル》",
        "short_description": "敵が不安定特性を持つとき、命令を起動する。",
        "trigger_type": "enemy_trait",
        "trigger_value": "unstable",
        "max_condition_events": 1,
        "prefix_ja": "不安定反応式",
        "prefix_en": "NOISE",
        "timing_label": "敵特性確認時",
    ...
    "enemy_signal_overcharge": {
        "condition_key": "enemy_signal_overcharge",
        "name_ja": "過充填反応《オーバーチャージ・シグナル》",
        "short_description": "敵の高出力反応を検出したとき、命令を起動する。",
        "trigger_type": "enemy_signal",
        "trigger_value": "overcharge",
        "max_condition_events": 1,
        "prefix_ja": "過充填反応式",
        "prefix_en": "SENTINEL",
        "timing_label": "敵戦術の予兆検出時",
        "is_active": True,
        "sort_order": 110,
    },
    "enemy_signal_aegis": {
        "condition_key": "enemy_signal_aegis",
        "name_ja": "装甲展開反応《イージス・シグナル》",
        "short_description": "敵の装甲展開反応を検出したとき、命令を起動する。",
        "trigger_type": "enemy_signal",
        "trigger_value": "aegis",
        "max_condition_events": 1,
        "prefix_ja": "装甲展開反応式",
    ...
    "enemy_signal_lock_on": {
        "condition_key": "enemy_signal_lock_on",
        "name_ja": "照準固定反応《ロックオン・シグナル》",
        "short_description": "敵の照準固定反応を検出したとき、命令を起動する。",
        "trigger_type": "enemy_signal",
        "trigger_value": "lock_on",
        "max_condition_events": 1,
        "prefix_ja": "照準固定反応式",
        "prefix_en": "GUARD",
        "timing_label": "敵戦術の予兆検出時",
    ...
    "enemy_signal_phase_shift": {
        "condition_key": "enemy_signal_phase_shift",
        "name_ja": "位相変調反応《フェイズ・シグナル》",
        "short_description": "敵の位相変調反応を検出したとき、命令を起動する。",
        "trigger_type": "enemy_signal",
        "trigger_value": "phase_shift",
        "max_condition_events": 1,
        "prefix_ja": "位相変調反応式",
        "prefix_en": "TRACE",
        "timing_label": "敵戦術の予兆検出時",
