...
class BattleShortReplayHelperTests(unittest.TestCase):
    ...
    def test_normal_replay_builds_turn_cards_until_finisher(self):
        ...
        self.assertEqual(replay["turns"][-1]["steps"][0]["damage"], 8)
        self.assertEqual(replay["turns"][-1]["steps"][0]["value_label"], "-800")
        self.assertIn("-800", replay["turns"][-1]["steps"][0]["result_label"])
