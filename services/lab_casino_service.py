...
LAB_CASINO_BET_AMOUNTS = (10, 20, 30)
LAB_CASINO_STARTING_COINS = 0
LAB_CASINO_DAILY_GRANT = 40
LAB_CASINO_WATCH_BONUS = 5
LAB_CASINO_COIN_CAP = 5000
LAB_CASINO_ODDS_MIN = 1.1
LAB_CASINO_ODDS_MAX = 1.5
